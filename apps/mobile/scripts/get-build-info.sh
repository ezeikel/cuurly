...
if [[ "$PLATFORM" == "ios" || "$PLATFORM" == "all" ]]; then
    ...
    IOS_URL="https://expo.dev/accounts/prayasyougo/projects/pray-as-you-go/builds/$IOS_ID"
...
if [[ "$PLATFORM" == "android" || "$PLATFORM" == "all" ]]; then
    ...
    ANDROID_URL="https://expo.dev/accounts/prayasyougo/projects/pray-as-you-go/builds/$ANDROID_ID"
